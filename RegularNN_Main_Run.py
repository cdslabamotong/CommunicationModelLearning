...
OutputFilePath = f'/home/cds/Documents/worms_propagation_model/Results/{Graph_Name}/RegularNN/Samples{SampleSize}Node{NumNode}_Seed{NumSeed}_Worms{NumWorms}'
