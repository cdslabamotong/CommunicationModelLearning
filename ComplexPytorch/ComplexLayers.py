...
class ModuleStageOne(Module):
    def forward(self, input, threshold):
        return complex_stageone_threshold(input, threshold)


class ModuleStageTwo(Module):
    def forward(self, input):
        return complex_stagetwo_threshold(input)


class ModuleRecover(Module):
    def forward(self, input, wormsindex_tensor):
        return complex_recovery(input, wormsindex_tensor)
