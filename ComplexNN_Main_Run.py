...
OutputFilePath = f'/home/cds/Documents/worms_propagation_model/Results/{Graph_Name}/ComplexNN/Samples{SampleSize}Node{NumNode}_Seed{NumSeed}_Worms{NumWorms}_TrainStep{TrainStep}'
