...
OutputFilePath = f'/home/cds/Documents/worms_propagation_model/Results/{Graph_Name}/Random/Samples{SampleSize}Node{NumNode}_Seed{NumSeed}_Worms{NumWorms}'
...
RandomTrain = Random_WriteResults(OutputFilePath,
                                  TrainSizeSet,
                                  TestSizeSet,
                                  SampleSize,
                                  InputFilePath,
